...
def _make_state(**overrides) -> dict:
    state: dict = {
        ...
        "requirements": {
            ...
            "non_functional_requirements": [{"id": "NFR-01", "description": "CLI only", "category": "usability"}],
            "user_stories": [{"id": "US-01", "description": "As a user, I want to add tasks", "priority": "P0"}],
        ...
        "architecture": {
            ...
            "components": [
                {
                    "name": "CLI",
                    "description": "Handles CLI args",
                    "technology": "Python",
                    "responsibilities": ["Parse args"],
                    "dependencies": [],
                }
            ],
